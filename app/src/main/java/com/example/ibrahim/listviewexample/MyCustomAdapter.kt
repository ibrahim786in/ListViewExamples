...
import kotlinx.android.synthetic.main.cust_list_design_img.view.*
import java.io.File
...
class MyCustomAdapter(var files1: Array<File>, var customListViewExample: CustomListViewExample) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        /*   val viewInf = inflater.inflate(R.layout.custlistvvideo, null) //This is for the Video Play
